...
DROP TABLE IF EXISTS `class_subject_teaching`;
...
--
-- Dumping data for table `class_subject_teaching`
--

LOCK TABLES `class_subject_teaching` WRITE;
/*!40000 ALTER TABLE `class_subject_teaching` DISABLE KEYS */;
/*!40000 ALTER TABLE `class_subject_teaching` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2016-05-29 16:43:59
