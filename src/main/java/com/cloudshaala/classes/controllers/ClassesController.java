...
public class ClassesController {
	...
	public List<TheClass> searchByTeacherAndIntitution(@PathVariable("teacher") String teacher,
	...
	public List<TheClass> searchByCourseAndIntitution(@PathVariable("course") String course,
			@PathVariable("id") String id) {
		return service.searchByCourseAndIntitution(course, id);

	}

	@RequestMapping(value = "/search/course/{course}/section/{section}/session/{session}/intitution/{id}",method=RequestMethod.GET)
	public List<TheClass> searchCourseIdAndSectionAndAcademicSessionAndInstitutionIdOrderByTitleDesc(@PathVariable("course") String course,@PathVariable("section") String section,@PathVariable("session") String session,@PathVariable("id") String id){
    	return service.searchCourseIdAndSectionAndAcademicSessionAndInstitutionIdOrderByTitleDesc(Long.parseLong(course),Long.parseLong(section) , Long.parseLong(session), Long.parseLong(id));
